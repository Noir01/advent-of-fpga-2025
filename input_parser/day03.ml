(** Day 03 input parser.
    ...
    Outputs raw digit strings, one per line. Each string contains digits 1-9. Encoding to
    Bits happens in the runner/test since input_parser doesn't depend on Hardcaml. *)
